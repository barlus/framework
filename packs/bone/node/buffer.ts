...
export class Buffer extends Uint8Array {
    ...
    static from(str, encoding?): Buffer{
        throw new Error('Must be overloaded by native');
    }
    /**
     ...
     */
    static byteLength?(string: string | Buffer | DataView | ArrayBuffer, encoding?: string): number;
    /**
     ...
     * @param size count of octets to allocate
     */
    static allocUnsaf?(size: number): Buffer;
    /**
