...
import {Zlib}    from "@barlus/bone/node/zlib";
...
export class PerMessageDeflate {
  ...
  offer() {
    const params: {
      ...
      server_max_window_bits?: boolean
      client_max_window_bits?: boolean
    } = {};
...
function inflateOnError(err) {
  //
  // There is no need to call `ZlibBase#close()` as the handle is automatically
