...
import { IFunctionExpectation } from './interfaces/function-expectation';
import { IObjectExpectation } from './interfaces/object-expectation';

export class Expectation<T> implements IExpectation<T>, IBooleanExpectation, INumberExpectation, IStringExpectation, IFunctionExpectation, IArrayExpectation<T>, IObjectExpectation<T> {
