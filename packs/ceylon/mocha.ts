declare const require,global,module,exports;
...
declare namespace Mocha {
    interface ISuiteCallbackContext{[s:string]:any}
    interface ITestCallbackContext{[s:string]:any}
    interface IHookCallbackContext{[s:string]:any}
}
...
function makeSuiteObject(context: TestFunctions) {
...
function makeTestObject(context: TestFunctions) {
