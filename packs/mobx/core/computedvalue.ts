    ...
    public set(value: T) {
        if (this.setter) {
            invariant(
                ...
                `The setter of computed value '${this.name}' is trying to update itself. ` +
                `Did you intend to update an _observable_ value, instead of the computed property?`
            );
