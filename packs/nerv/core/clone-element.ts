...
import { extend, clone, isArray, isString } from '../utils/index'
import { isVText, isVNode, EMPTY_CHILDREN, VType, isNullOrUndef, isPortal, isInvalid } from '../shared/index'
import { createVoid } from './vdom/create-void'

export function cloneElement(vnode, props?: object, ...children): any {
    if (isVText(vnode)) {
