import { isValidElement as isValidNervElement, VType, isComponent, isInvalid } from '../shared/index'
...
export function unstable_renderSubtreeIntoContainer(parentComponent, vnode, container, callback) {
    ...
    const wrapper = createElement(WrapperComponent, { context: parentComponent.context }, vnode);
