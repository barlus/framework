import { extend, isFunction, isNumber, isString } from '../utils/index'
...
import { ComponentWrapper } from './full-component'
...
export function mountStatelessComponent(vnode: StatelessComponent, parentContext) {
...
export function reRenderStatelessComponent(
    prev: StatelessComponent,
    current: StatelessComponent,
    parentContext: Object,
    domNode: Element
) {
...
export function unmountComponent(vnode: ComponentWrapper) {
    const component = vnode.component;
...
export function unmountStatelessComponent(vnode: StatelessComponent) {
