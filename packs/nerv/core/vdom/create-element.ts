import { isSupportSVG, isArray, isString, isNumber, doc, isBoolean } from '../../utils/index'
import {
    isNullOrUndef,
    VirtualNode,
    isInvalid,
...
export function mountChild(child: VNode, domNode: Element, parentContext: Object, isSvg?: boolean, parentComponent?) {
