...
function createDevToolsBridge() {
    ...
    const ComponentTree = {
        getNodeFromInstance(instance) {
            console.info('ComponentTree.getNodeFromInstance',instance);
            return instance.node
        },
        getClosestInstanceFromNode(dom) {
            console.info('ComponentTree.getClosestInstanceFromNode',dom);
    ...
    const Mount: any = {
        ...
        _renderNewRootComponent(/* instance, ... */) {
            console.info('//Mount._renderNewRootComponent');
        }
    };
    ...
    const Reconciler: any = {
        ...
        mountComponent(/* instance, ... */) {
            console.info('//Reconciler.mountComponent');
        },
        // tslint:disable-next-line:no-empty
        performUpdateIfNecessary(/* instance, ... */) {
            console.info('//Reconciler.performUpdateIfNecessary');
        },
        // tslint:disable-next-line:no-empty
        receiveComponent(/* instance, ... */) {
            console.info('//Reconciler.receiveComponent');
        },
        // tslint:disable-next-line:no-empty
        unmountComponent(/* instance, ... */) {
            console.info('//Reconciler.unmountComponent');
        }
    };
