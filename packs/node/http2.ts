...
export interface Http2Session extends Emitter {
    destroy(): void;
    readonly destroyed: boolean;
...
export interface Http2ServerResponse extends Emitter {
...
export declare function getPackedSettings(settings: Settings): Settings;
export declare function getUnpackedSettings(buf: Buffer | Uint8Array): Settings;
export declare function createServer(onRequestHandler?: (request: Http2ServerRequest, response: Http2ServerResponse) => void): Http2Server;
export declare function createServer(options: ServerOptions, onRequestHandler?: (request: Http2ServerRequest, response: Http2ServerResponse) => void): Http2Server;
export declare function createSecureServer(onRequestHandler?: (request: Http2ServerRequest, response: Http2ServerResponse) => void): Http2SecureServer;
