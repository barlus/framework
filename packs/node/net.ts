...
export declare function connect(port: number, host?: string, connectionListener?: Function): Socket;
export declare function connect(path: string, connectionListener?: Function): Socket;
export declare function createConnection(options: NetConnectOpts, connectionListener?: Function): Socket;
export declare function createConnection(port: number, host?: string, connectionListener?: Function): Socket;
export declare function createConnection(path: string, connectionListener?: Function): Socket;
