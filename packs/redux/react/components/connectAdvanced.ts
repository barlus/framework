...
import {createElement}                                               from '@barlus/react'
import {invariant}                                                   from '@barlus/react'
import {AdvancedComponentDecorator, ConnectOptions, SelectorFactory} from '../types';
import {hoistStatics}                                                from '../utils/nonEeactStatics'
...
export function connectAdvanced<S, TP, TOP, TFP = {}>(selectorFactory: SelectorFactory<S, TP, TOP, TFP>, options?: ConnectOptions & TFP): AdvancedComponentDecorator<TP, TOP> {
  ...
  */
  const {
    ...
    ...connectOptions
  } = (options as any) as ConnectOptions;
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    class Connect extends Component {
      ...
      initSelector() {
        const sourceSelector = selectorFactory(this.store.dispatch, selectorFactoryOptions as any as TFP);
