    ...
    if (range) {
      ...
      if (!selected || !selected[ 'start' ]) {
        ...
        if (!selected[ 'end' ]) {
          ...
          this.props.onDateSelect && this.props.onDateSelect(s);
        } else {
      ...
      <div className={Theme.container}>
        ...
        <div className={Theme.calendarBody}>
          ...
          {this.activeMonthDays.map((day, index) => {
            ...
            let item = <div {...t} key={index}
                            className={classes(Theme.calendarDate, Theme.currentMonth, range && this.rangeClasses(this.state.activeDate, day), tooltipLabel && "tooltip")}>
              <Button onClick={() => {
                this.onDayClick(day)
