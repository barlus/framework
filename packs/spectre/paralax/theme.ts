import {$,deg,px,linearGradient,list,nest,color,CSSProperties,percent,perspective,rotateX,rotateY,s,scale,stylesheet,translate3d,translateZ,} from "@barlus/styles"
