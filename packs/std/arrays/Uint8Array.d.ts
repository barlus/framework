...
declare class Uint8Array {
    ...
    constructor(arrayOrArrayBuffer: ArrayLike<number> | ArrayBufferLike);
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    static from(arrayLike: ArrayLike<number>, mapfn?: (v: number, k: number) => number, thisArg?: any): Uint8Array;
...
declare class Uint8ClampedArray {
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    static from(arrayLike: ArrayLike<number>, mapfn?: (v: number, k: number) => number, thisArg?: any): Uint8ClampedArray;
    /**
     * Creates an array from an array-like or iterable object.
     * @param arrayLike An array-like or iterable object to convert to an array.
     * @param mapfn A mapping function to call on every element of the array.
