...
export class DocAvatars extends DocPage {
    ...
    render() {
        return  <DocSection id={this.id} title={this.title}>
            ...
            <DocSample columns={2}>
                <div>
                    <Avatar xl src='https://picturepan2.github.io/spectre/img/avatar-1.png' icon='https://picturepan2.github.io/spectre/img/avatar-5.png'/>
                    <Avatar lg src='https://picturepan2.github.io/spectre/img/avatar-2.png' icon='https://picturepan2.github.io/spectre/img/avatar-4.png' />
                    <Avatar    src='https://picturepan2.github.io/spectre/img/avatar-3.png' icon='https://picturepan2.github.io/spectre/img/avatar-3.png' />
                    <Avatar sm src='https://picturepan2.github.io/spectre/img/avatar-4.png' icon='https://picturepan2.github.io/spectre/img/avatar-2.png' />
                    <Avatar xs src='https://picturepan2.github.io/spectre/img/avatar-5.png' icon='https://picturepan2.github.io/spectre/img/avatar-1.png' />
                </div>
            </DocSample>
            <DocText text={`
