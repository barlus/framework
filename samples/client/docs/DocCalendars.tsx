...
export class DocCalendars extends React.PureComponent<{}, {}> {
    render() {
        return <div id="calendars" className="container">
            <h3 className="s-title"><a href="#calendars" className="anchor" aria-hidden="true">#</a>Calendars
            </h3>
            <div className="docs-note">
                <p>Calendars are designed for date or date range picker and events display. It is made with flex
                    layout.</p>
            </div>
            ...
            <h4 id="calendars-sizes" className="s-subtitle">Calendars sizes</h4>
            <div className="columns">
