...
export class DocCarousels extends React.PureComponent<{}, {}> {
    render() {
        return <div id="carousels" className="container">
            <h3 className="s-title"><a href="#carousels" className="anchor" aria-hidden="true">#</a>Carousels
            </h3>
