...
export class DocMedia extends DocPage {
    ...
    render() {
        return <DocSection id={this.id} title={this.title}>
            ...
            `}/>
            <DocSample>
                <Image responsive src="https://picturepan2.github.io/spectre/img/osx-el-capitan.jpg" alt="macOS El Capitan Wallpaper"/>
            </DocSample>
            <DocText text={`
            ...
            <DocSample columns={2}>
                <Figure>
                    <Image  contain  src="https://picturepan2.github.io/spectre/img/osx-yosemite.jpg"   style={{ background: '#f8f9fa', height: '10rem', width: '100%' }}/>
                    <FigureCaption className="text-center">contain</FigureCaption>
                </Figure>
                <Figure>
                    <Image  cover src="https://picturepan2.github.io/spectre/img/osx-yosemite-2.jpg"   style={{ background: '#f8f9fa', height: '10rem', width: '100%' }}/>
