...
export class DocResponsive extends DocPage {
    ...
    render() {
        return <DocSection id={this.id} title={this.title}>
            ...
            <DocTiles>>Responsive visibility</DocTiles>
            <DocNote>The responsive visibility utilities help show and hide elements on specific viewport sizes.</DocNote>
            <DocSample>
