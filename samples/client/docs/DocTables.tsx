...
export class DocTables extends DocPage {
    ...
    render() {
        return <DocSection id={this.id} title={this.title}>
            ...
            <div className="docs-note">
                <p>Add the <code>table</code> class to any &lt;table&gt; element. The class will add padding,
                    border and
            ...
            <div className="docs-note">
                <p>If you need the tables with horizontal scroll, add the <code>table-scroll</code> class to
                    the &lt;table&gt;
                    element. </p>
            </div>
