 ...
 *
 */
export class Component<P={},S={}> extends React.Component<IComponentProps&P,S> {
    protected componentName:string;
    protected classText:string;
    protected control:Node;
    protected setControlRef:(control)=>void;
    protected _mdcProps:string[];
    constructor() {
        super();
    ...
    attachRipple() {
        if (this.props.ripple && this.control) {
            console.warn('ripple not implemented');
    ...
    render() {
        this.buildClassName();
        // Fetch a VNode
        const componentProps = this.props as P & JSX.HTMLAttributes;
